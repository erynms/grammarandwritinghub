...
const keywordMappings = {
    ...
    'quote integration': ['integrating-quotations', 'literary-analysis-quotes'],
    'integrating quotes': ['integrating-quotations', 'literary-analysis-quotes'],
    'quote sandwich': ['integrating-quotations', 'literary-analysis-quotes'],
    'dropped quote': ['dropped-quotes'],
    'dropped quotes': ['dropped-quotes'],
    'floating quote': ['dropped-quotes'],
    'orphan quote': ['dropped-quotes'],
    ...
    'how to integrate quotes': ['integrating-quotations'],
    'integrating quotations': ['integrating-quotations'],
    'quote flow': ['integrating-quotations'],
    'introducing quotations': ['integrating-quotations'],
    'quote analysis': ['integrating-quotations'],
    'analyzing quotes': ['integrating-quotations'],
    'following up quotes': ['integrating-quotations'],
    'quote lead-in': ['integrating-quotations'],
    'lead in quote': ['integrating-quotations'],

    // Signal Phrases
    'signal phrase': ['integrating-quotations', 'mla-signal-phrases'],
    'signal phrases': ['integrating-quotations', 'mla-signal-phrases'],
    'introduce quote': ['integrating-quotations', 'mla-signal-phrases'],
    'introducing quotes': ['integrating-quotations', 'mla-signal-phrases'],
    'according to': ['integrating-quotations', 'mla-signal-phrases'],
    'attribution': ['integrating-quotations', 'mla-signal-phrases'],
    'source integration': ['integrating-quotations', 'mla-signal-phrases'],
    'signal verb': ['integrating-quotations', 'mla-signal-phrases'],
